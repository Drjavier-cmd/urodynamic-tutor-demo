...
- constructor educativo de informe razonado;
- retroalimentacion adaptativa;
- 47 casos sinteticos con dificultad progresiva;
- gobernanza cientifica visible;
- modo docente y exportacion individual anonima;
- descripcion, patrones de linea y tabla equivalente para los trazados.

Material exclusivamente educativo. No debe utilizarse para diagnostico, informes
